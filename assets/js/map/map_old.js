...
function restorePerf(data) {
  ...
  if (name in mapPerf) {
    data.perf = mapPerf[name];
  }

  if (name in mapAdditional) {
    data.additional = mapAdditional[name];
  }
...
function initMap(width, mapData, options) {
  const { color, ignoreAuth, price } = options;

  // Restore parents and performance data
...
function drawMap(color, ignoreAuth) {
  // Calculate height of the map container
  var h =
    Math.max(document.documentElement.clientHeight, window.innerHeight || 0) -
    10;
  if (!$(".narrow").is(":visible")) {
    // Reduce height if there is a narrow container
    h -= 280;
  }

  // Set height of the map container
  $("#body").height(h + 30);

  // Calculate width of the map container
              ...
              children: [
                {
                  children: [
                    ...
                    {
                      name: "包钢股份",
                      scale: 5.828606932e10,
                      id: "600010.SH",
                    },
                    {
                      name: "宝钢股份",
                      scale: 1.5063016261e11,
                      id: "600019.SH",
                    },
              ...
              children: [
                {
                  children: [
                    ...
                    {
                      name: "珠江啤酒",
                      scale: 2.051755501e10,
                      id: "002461.SZ",
                    },
                    {
                      name: "百润股份",
                      scale: 2.808149497e10,
                      id: "002568.SZ",
                    },
              ...
              children: [
                {
                  children: [
                    ...
                    {
                      name: "招商积余",
                      scale: 1.565973387e10,
                      id: "001914.SZ",
                    },
                    {
                      name: "招商蛇口",
                      scale: 1.1266473716e11,
                      id: "001979.SZ",
                    },
              ...
              children: [
                {
                  children: [
                    ...
                    {
                      name: "国金证券",
                      scale: 2.803514462e10,
                      id: "600109.SH",
                    },
                    { name: "华创阳安", scale: 11324513778, id: "600155.SH" },
                    {
                      name: "西南证券",
                      scale: 2.094335485e10,
                      id: "600369.SH",
                    },
              ...
              children: [
                ...
                },
                {
                  children: [
                    ...
                    {
                      name: "中航沈飞",
                      scale: 1.1098539356e11,
                      id: "600760.SH",
                    },
                    {
                      name: "中航重机",
                      scale: 3.543155332e10,
                      id: "600765.SH",
                    },
  ...
  function xuanran(result) {
    // Use the treemap layout to generate nodes
    var nodes = treemap.nodes(result);

    // Parse the map performance data from the nodes
    var json = "";
    ...
    json = "{" + json.substr(1) + "}";
    mapAdditional = {};
    mapPerf = JSON.parse(json);
    var zntyMapData = nodes[0];

    // Initialize the map with the map data and performance data
    initMap(w, zntyMapData, color, ignoreAuth);
  }
}
    ...
    e.exports = {
      ...
      updateData: function (isFirst) {
        ...
        t = {
          errcode: 0,
          errmsg: "success",
          data: { 浩丰科技: "1.03", 华锦股份: "5.66", 百普赛斯: "1.49" },
        };
        var nodes = t.data;
        var stocks = {};
